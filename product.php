    ...
    <div class="row">
      ...
      <div class="col ">
        <div class="card" style="width: 18rem;">
          <img src="images/product/<?php echo ($img); ?>" class="card-img-top" alt="...">
          <div class="card-body my-5">
            <div class="row">
              ...
              <div class="col">
                <a href="http://localhost/ecommerce/cart.php?id=<?php echo ($id); ?>" class="btn btn-warning pbtn my-2 mx-0">ADD CART</a>
              </div>
            </div>
          </div>
        </div>
